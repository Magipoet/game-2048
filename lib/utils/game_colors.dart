...
class GameColors {
  ...
  static const Color frozenNumberColor = Color(0xFF87CEEB);
  static const Color frozenNumberTextColor = Color(0xFF2F4F4F);
  static const Color iceAreaColor = Color(0x66ADD8E6);

  static Color getTileColor(int value, {CellType? cellType}) {
    if (cellType == CellType.woodBlock) {
      return woodBlockColor;
    }
    if (cellType == CellType.frozenNumber) {
      return frozenNumberColor;
    }
    switch (value) {
      case 2:
